...
console.log('logical' + 1^1);
console.log('logical' + 0^1);
console.log('logical' + 1^0);
console.log('logical' + 0^0);
console.log('logical' + 1^0^1);
console.log('logical' + 0^1^0);
console.log('logical' + 1^1^1);
console.log('logical' + 0^0^0);
...
const fruits =new Map([["apples", 500],["banana",300],["orange",400]]);
...
console.log( 'length of string 1 - '+length);


let text1 = "Apple, Banana, Kiwi ";

let length1 = text.slice(7, 13);

console.log("length of stirng 2 is :-" + length1);


let length2 = text1.slice(7);

console.log("length of string 3 is :- ", length2);


let length3 = text1.slice(-13 , -7);

console.log("length of string is 4 :- "+ length3);

let length4 = text1.substring(7,13);

console.log("length of string is 5 :- "+ length4);


let length5 = text1.substr(7, 6);
console.log("length of sting is 6 :-" + length5);


let length6 = text1.substr(7);
console.log("length of sting is 7 :-" + length6);

//  Replace methods 

let replace = "please Visit Googlechorm";

let rplc = replace.replace("Googlechorm", "SKillChrom");

console.log("The Replace strings is :-" + rplc);



//  String REplace all 

let world =  "I love cats. Cats are very easy to love. Cats are very popular.";

 w2 = world.replaceAll("cats","dogs")
 w1 = world.replaceAll("Cats","Dogs")

console.log("Rplace all strings:- " + w1 + "Another string is:- "+ w2);
...
console.log( "upper casee stirgs is :- " +uppercase);


let lower = " HEELO WELCOME TO MY PAGE ";

let lowe1 = lower.toLowerCase();

console.log("lower case stirngs is :- "+ lowe1);
